...
#define SD_POWER_EN()		LATBbits.LATB12 = 1	/* CS = H */
#define	SD_POWER_DISEN()	LATBbits.LATB12 = 0	/* CS = L */
...
{
	do {
		SPI2BUF = *buff++; while(SPI2STATbits.SPITBF == TRUE) ; SPI2BUF; 
		SPI2BUF = *buff++; while(SPI2STATbits.SPITBF == TRUE) ; SPI2BUF; 
...
{
	do {
		SPI2BUF = 0xFF; while(SPI2STATbits.SPIRBE == TRUE) ; *buff++ = SPI2BUF; 
		SPI2BUF = 0xFF; while(SPI2STATbits.SPIRBE == TRUE) ; *buff++ = SPI2BUF; 
